...
def run_cross_entropy(
    ...
    def cross_entropy_loss(inputs, labels):
        ...
        return loss
    return cross_entropy_loss(inputs=inputs, labels=targets)
...
def process_chunk(chunk):
    local_default_dict = defaultdict(int)
    ...
    for m in re.finditer(PAT, chunk):
        sub_word = m.group(0)
        local_default_dict[word_to_bytes_tuple(sub_word)] += 1
    return local_default_dict
